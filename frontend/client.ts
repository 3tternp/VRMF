 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_control_create_create } from "~backend/control/create";
import { list as api_control_list_list } from "~backend/control/list";
import { update as api_control_update_update } from "~backend/control/update";
...
export namespace control {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_control_create_create>): Promise<ResponseType<typeof api_control_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/controls`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_control_create_create>
        }

        /**
         * Lists controls, optionally filtered by risk ID
         */
        public async list(params: RequestType<typeof api_control_list_list>): Promise<ResponseType<typeof api_control_list_list>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                "risk_id": params["risk_id"] === undefined ? undefined : String(params["risk_id"]),
            })

            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/controls`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_control_list_list>
        }

        /**
         * Updates an existing control
         */
        public async update(params: RequestType<typeof api_control_update_update>): Promise<ResponseType<typeof api_control_update_update>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/controls/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_control_update_update>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_risk_create_create } from "~backend/risk/create";
import { dashboard as api_risk_dashboard_dashboard } from "~backend/risk/dashboard";
import { deleteRisk as api_risk_delete_deleteRisk } from "~backend/risk/delete";
import { get as api_risk_get_get } from "~backend/risk/get";
import { list as api_risk_list_list } from "~backend/risk/list";
import { update as api_risk_update_update } from "~backend/risk/update";
...
export namespace risk {
    ...
    export class ServiceClient {
         ...
         * Creates a new risk
         */
        public async create(params: RequestType<typeof api_risk_create_create>): Promise<ResponseType<typeof api_risk_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/risks`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_risk_create_create>
        }

        /**
         * Retrieves dashboard statistics and risk heatmap data
         */
        public async dashboard(): Promise<ResponseType<typeof api_risk_dashboard_dashboard>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/risks/dashboard`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_risk_dashboard_dashboard>
        }

        /**
         * Deletes a risk
         */
        public async deleteRisk(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/risks/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves a specific risk by ID
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_risk_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/risks/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_risk_get_get>
        }

        /**
         * Lists all risks with optional filtering
         */
        public async list(params: RequestType<typeof api_risk_list_list>): Promise<ResponseType<typeof api_risk_list_list>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                category:               params.category === undefined ? undefined : String(params.category),
                "compliance_framework": params["compliance_framework"] === undefined ? undefined : String(params["compliance_framework"]),
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/risks`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_risk_list_list>
        }

        /**
         * Updates an existing risk
         */
        public async update(params: RequestType<typeof api_risk_update_update>): Promise<ResponseType<typeof api_risk_update_update>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                "annex_a_reference":               params["annex_a_reference"],
                asset:                             params.asset,
                ...
                "existing_controls":               params["existing_controls"],
                impact:                            params.impact,
                "impact_rationale":                params["impact_rationale"],
                likelihood:                        params.likelihood,
                "mitigation_plan":                 params["mitigation_plan"],
                "owner_id":                        params["owner_id"],
                "post_treatment_impact":           params["post_treatment_impact"],
                "post_treatment_likelihood":       params["post_treatment_likelihood"],
                "post_treatment_treatment_option": params["post_treatment_treatment_option"],
                "proposed_treatment_action":       params["proposed_treatment_action"],
                "residual_impact":                 params["residual_impact"],
                "residual_likelihood":             params["residual_likelihood"],
                "risk_owner_approval":             params["risk_owner_approval"],
                "risk_type":                       params["risk_type"],
                status:                            params.status,
                threat:                            params.threat,
                title:                             params.title,
                "treatment_action_owner":          params["treatment_action_owner"],
                "treatment_cost":                  params["treatment_cost"],
                "treatment_option":                params["treatment_option"],
                "treatment_status":                params["treatment_status"],
                "treatment_timescale":             params["treatment_timescale"],
