...
```bash
git remote add encore encore://risk-management-app-xcb2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/risk-management-app-xcb2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/risk-management-app-xcb2/settings/integrations/github)
